...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td height="150" background="images/biaoti.jpg"><br></td>
  </tr>
</table>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
          <tr>
            <td height="40" style="color:green;font-weight:bold;">&nbsp; 欢迎您留下宝贵意见：<br></td>
          </tr>
          <tr>
          ...
          <tr bgcolor="#F7F3F7">
			...
			<form name="form1" action="mem.do?method=addWord" method="post" style="margin:0px;">
			   <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2" style="color:green;font-weight:bold;">发表留言：<br></td>
                  </tr>
                  <tr>
                    <td colspan="2">&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="35"><input type="button"  onClick="checkForm()" value="提交留言"/></td>
                  </tr>
            </table>
			</form>
			</td>
